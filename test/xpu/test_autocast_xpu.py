...
class TestAutocastGPU(TestCase):
    def test_cast_cache_is_global(self):
        ...
        data = torch.randn(2, 3).to(device_type)
        weight = torch.nn.Parameter(torch.randn(4, 3).to(device_type))
...
class TestTorchAutocast(TestCase):
    def test_autocast_fast_dtype(self):
        gpu_fast_dtype = torch.get_autocast_dtype(device_type=device_type)
    ...
    def test_autocast_nograd_caching_issue_158232_cuda(self):
        ...
        self._test_autocast_nograd_caching_issue_158232_impl(device_type, torch.float16)
    ...
    def test_autocast_inference_mode_interaction_cuda(self):
        ...
        self._test_autocast_inference_mode_interaction_impl(device_type, torch.float16)
    ...
    def test_autocast_mixed_grad_contexts_cuda(self):
        ...
        self._test_autocast_mixed_grad_contexts_impl(device_type, torch.float16)
