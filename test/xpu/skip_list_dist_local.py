skip_dict = {
    ...
    "distributed/fsdp/test_fsdp_grad_acc.py": None,
    ...
    "distributed/fsdp/test_fsdp_misc.py": (
        # fsdp accuracy gaps
    ...
    "distributed/fsdp/test_wrap.py": None,
    ...
    "distributed/test_inductor_collectives.py": None,
    "../../../../test/distributed/test_multi_threaded_pg.py": None,
    "../../../../test/distributed/test_store.py": None,
    "distributed/pipelining/test_backward.py": None,
    "distributed/pipelining/test_microbatch.py": None,
    ...
    "distributed/tensor/parallel/test_micro_pipeline_tp.py": None,
    ...
    "distributed/tensor/test_dtensor_dispatch_overhead.py": None,
    "../../../../test/distributed/tensor/test_dynamic.py": None,
    "distributed/tensor/test_dtensor_export.py": None,
    ...
    "distributed/_composable/fsdp/test_fully_shard_comm.py": (
    ...
    "distributed/_shard/sharded_tensor/test_sharded_tensor.py": (
        # skip as Shard tensor are deprecated https://github.com/intel/torch-xpu-ops/issues/2004
    ...
    "distributed/_shard/sharded_tensor/test_sharded_tensor_reshard.py": None,
    "distributed/_shard/sharding_plan/test_sharding_plan.py": None,
    ...
    "distributed/checkpoint/e2e/test_e2e_save_and_load.py": None,
    ...
    "distributed/checkpoint/test_state_dict_utils.py": None,
    ...
    "distributed/optim/test_zero_redundancy_optimizer.py": None,
    ...
    "distributed/_composable/test_replicate_mixed_precision.py": None,
    "distributed/_composable/test_replicate_training.py": None,
    "distributed/_composable/test_replicate_with_fsdp.py": None,
    ...
    "distributed/_tools/test_sac_ilp.py": None,
    ...
    "distributed/checkpoint/test_state_dict_stager.py": None,
    ...
    "distributed/launcher/test_run.py": None,
    ...
    "distributed/tensor/debug/test_debug_mode.py": None,
    ...
    "distributed/test_pg_wrapper.py": None,
    "../../../../test/distributed/test_run.py": None,
    "distributed/test_serialization.py": None,
    "distributed/test_distributed_spawn.py": None,
    ...
    "distributed/test_data_parallel.py": None,
    "../../../../test/distributed/test_debug.py": None,
    "distributed/test_c10d_xccl_local.py": (
    ...
    "distributed/test_overlap_bucketing_unit.py": None,
    "../../../../test/distributed/pipelining/test_schedule_multiproc.py":None,
}

skip_dict_python = {
    "../../../../test/distributed/test_c10d_functional_native.py": None,
    # "distributed/pipelining/test_schedule_multiproc.py": None,  # Hang error.
    # "distributed/pipelining/test_stage.py": None,
    "../../../../test/distributed/pipelining/test_transformer.py": None,
}
