...
skip_list = (
    ...
    ### Error #1 in TestMathBitsXPU , totally 2 , RuntimeError: value cannot be converted to type float without overflow
    # issue 248

    "test_conj_view_addbmm_xpu_complex64",
    "test_neg_conj_view_addbmm_xpu_complex128",

    ### Error #2 in TestMathBitsXPU , totally 2 , RuntimeError: DispatchStub: unsupported device typexpu
    # issue 249

    "test_conj_view_conj_physical_xpu_complex64",
    "test_neg_conj_view_conj_physical_xpu_complex128",

    ### Error #3 in TestMathBitsXPU , totally 4 , RuntimeError: could not create a primitive descriptor for a deconvolution forward propagation primitive
    # issue 253
