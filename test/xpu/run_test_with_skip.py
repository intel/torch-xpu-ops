...
if args.skip_cases:
    try:
        ...
        for key in window_skip_dict:
            ...
            if key in merged_skip_dict:
                ...
                if should_skip_entire_file(window_skip_list):
                    ...
                    print(f"Windows entire file skip detected for {key}, using: {window_skip_list}")
                else:
                    # Otherwise, merge both lists and remove duplicates
                    combined_list = default_skip_list + [item for item in window_skip_list if item not in default_skip_list]
        ...
        print("Warning: window_skip_dict module not found, using default skip dictionary")
