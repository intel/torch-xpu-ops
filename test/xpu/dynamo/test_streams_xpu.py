...
class GraphModule(torch.nn.Module):
    def forward(self, mul: "f32[2, 2]", add: "f32[2, 2]", add_1: "f32[2, 2]", tangents_1: "f32[2, 2]", tangents_2: "f32[2, 2]"):
        ...
        # No stacktrace found for following nodes
        record_stream_default = torch.ops.streams.record_stream.default(mul_3, 1);  record_stream_default = None
...
class GraphModule(torch.nn.Module):
    def forward(self, getitem: "f32[2, 2]", mul: "f32[2, 2]", mul_1: "f32[2, 2]", mul_2: "f32[2, 2]", tangents_1: "f32[2, 2]", tangents_2: "f32[2, 2]"):
        ...
        # No stacktrace found for following nodes
        record_stream_default = torch.ops.streams.record_stream.default(mul_4, 3);  record_stream_default = None
        subgraph_record_event_default = self.subgraph_record_event_default
...
class GraphModule(torch.nn.Module):
    def forward(self, getitem: "f32[2, 2]", getitem_3: "f32[2, 2]", getitem_2: "f32[2, 2]", getitem_4: "f32[2, 2]", getitem_6: "f32[2, 2]", tangents_1: "f32[2, 2]", tangents_2: "f32[2, 2]", tangents_3: "f32[2, 2]"):
        ...
        # No stacktrace found for following nodes
        record_stream_default = torch.ops.streams.record_stream.default(mul_7, 4);  record_stream_default = None
        subgraph_record_event_default = self.subgraph_record_event_default
        ...
        # No stacktrace found for following nodes
        record_stream_default_1 = torch.ops.streams.record_stream.default(mul_8, 3);  record_stream_default_1 = None
        subgraph_record_event_default_1 = self.subgraph_record_event_default_1
        ...
        # No stacktrace found for following nodes
        record_stream_default_2 = torch.ops.streams.record_stream.default(mul_11, 2);  record_stream_default_2 = None
        ...
        # No stacktrace found for following nodes
        record_stream_default_3 = torch.ops.streams.record_stream.default(mul_12, 4);  record_stream_default_3 = None
