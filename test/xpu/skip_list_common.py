skip_dict = {
    "test_ops_xpu.py": (
        ...
        ### Error #0 in TestMathBitsXPU, RuntimeError: Double datatype matmul is not supported in oneDNN
    ...
    "test_transformers_xpu.py": (
        ...
        # oneDNN issues
        # Double datatype matmul is not supported in oneDNN
        # https://github.com/intel/torch-xpu-ops/issues/253
    ...
    "test_linalg_xpu.py": (
        ...
        # NotImplementedError: The operator 'aten::linalg_solve_triangular.out' is not currently implemented for the XPU device.
        ...
        # NotImplementedError: Could not run 'aten::addmm' with arguments from the 'SparseXPU' backend.
