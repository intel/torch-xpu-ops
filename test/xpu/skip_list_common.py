...
skip_dict = {
    ...
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_activation_sparsifier.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_composability.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_data_scheduler.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_data_sparsifier.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_kernels.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_parametrization.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_qlinear_packed_params.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_scheduler.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_sparsifier.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_sparsity_utils.py": None,
    f"{PYTORCH_TEST_DIR}/ao/sparsity/test_structured_sparsifier.py": None,
}