...
skip_dict = {
    ...
    "test_ops_xpu.py": (
        ...
        # Known XPU issues reported by the nightly test results.
        ...
        "test_cow_input_nn_functional_conv",
        "test_dtypes_nn_functional_conv",
        ...
        "test_fake_crossref_backward_amp_fft_",
        "test_fake_crossref_backward_no_amp_fft_",
        "test_python_ref_executor__refs_fft_hfft2_executor_aten_xpu",
        "test_python_ref__refs_true_divide_xpu_complex32",
        "test_fake_crossref_backward_amp_nn_functional_max_unpool2d",
        "test_fake_crossref_backward_no_amp_nn_functional_max_unpool2d",
        "test_errors_arange_xpu",
    ),
    "test_optim_xpu.py": (
        "test_fused_mixed_precision_hook_skips_existing_state_amsgrad_False_AdamW_xpu_float32",
        "test_fused_mixed_precision_hook_skips_existing_state_amsgrad_False_Adam_xpu_float32",
        "test_fused_mixed_precision_hook_skips_existing_state_amsgrad_True_AdamW_xpu_float32",
        "test_fused_mixed_precision_hook_skips_existing_state_amsgrad_True_Adam_xpu_float32",
        "test_fused_mixed_precision_numerics_AdamW_xpu_float32",
        "test_fused_mixed_precision_numerics_Adam_xpu_float32",
        "test_fused_mixed_precision_state_init_amsgrad_False_AdamW_xpu_float32",
        "test_fused_mixed_precision_state_init_amsgrad_False_Adam_xpu_float32",
        "test_fused_mixed_precision_state_init_amsgrad_True_AdamW_xpu_float32",
        "test_fused_mixed_precision_state_init_amsgrad_True_Adam_xpu_float32",
        "test_state_dict_with_cuda_params_Muon_xpu_float32",
    ),
    ...
    "test_unary_ufuncs_xpu.py": (
        ...
        "test_reference_numerics_extremal_round_decimals_3_xpu_bfloat16",
        ...
        "test_reference_numerics_normal_round_decimals_3_xpu_bfloat16",
