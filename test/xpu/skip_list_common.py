...
skip_dict = {
    ...
    "distributed/fsdp/test_fsdp_mixed_precision_xpu.py": None,
    "distributed/fsdp/test_fsdp_optim_state_xpu.py": None,
    ...
    "dynamo/test_ctx_manager.py": (
        "test_gpu_device",
        "test_gpu_amp_autocast",
        "test_autocast_float64",
    ),
    "dynamo/test_functions_xpu.py": None,
    "dynamo/test_higher_order_ops_xpu.py": (
        "test_function",
    ...
    "dynamo/test_repros_xpu.py": (
        ...
        "test_exec_wildcard_import",
        "test_dataclass_init_with_default_factory_with_inputs",
        "test_setitem_tensor_prop",
        "test_out_root_cell_tuple_shape_change",
        "test_tensor_split",
        "test_modules",
        "test_tensor_split_within_device_cm",
        "test_export_vs_dynamo_for_multiheadattention",
        "test_intermediate_leaf_requires_grad",
        "test_output_aliases_intermediate",
        "test_setitem_tuple_boolean_mask_diff",
        "test_move_tensor_subclass_parameter_after_compile",
        "test_multi_dot_import",
        "test_tensor_uniform",
        "test_dedup_global",
        "test_sigmoid_out",
        "test_invalid_seq_unpack",
        "test_overlapping_inputs_with_dynamic_shapes_error",
        "test_threading_local",
        "test_deferred_runtime_asserts",
        "test_multi_import",
        "test_overwriting_params",
        "test_is_make_fx_tracing",
        "test_sigmoid_out2",
        "test_for_loop_graph_break",
        "test_is_symbolic_tracing",
        "test_multiheadattention_tracing_slowpath_matches_fastpath_layout",
        "test_size_typematch",
        "test_partially_initialized_module_property",
        "test_tokenization",
        "test_delattr",
        "test_for_loop_graph_break_before",
        "test_slice_into_list_mutable",
        "test_named_buffers",
        "test_isinstance_dtype",
        "test_delattr_raises",
        "test_torch_compile_in_compile_frame",
        "test_partitioner_cse_respects_mutation_boundaries",
        "test_foreach_decomp_arg_names",
        "test_patch_track_step_called_skipped",
        "test_nanmean_out",
        "test_torch_ops_aten",
        "test_delattr_return",
        "test_slicing_dynamic_shape",
        "test_isinstance_storage",
        "test_fsdp_set_input_mutation_applied_when_input_gets_no_gradients",
        "test_slicing_dynamic_shape_setitem",
        "test_pointless_graph_removal",
        "test_torch_tensor_ops",
        "test_issue111522",
        "test_delete_local_error",
        "test_negative_floor_div_solve",
        "test_function_in_skipfiles",
        "test_sort_out",
        "test_issue111918",
        "test_deleted_compile_wrapper_segfault",
        "test_torch_tensor_ops_no_graph_break",
        "test_negative_shape_guard",
        "test_preserve_stride_with_clone",
        "test_functools_wraps",
        "test_sort_out2",
        "test_primtorch",
        "test_nested_while_loop_graph_break",
        "test_delsubscr",
        "test_torch_variable_type",
        "test_issue114171",
        "test_gan_repro_trying_to_backward_through_the_graph_a_second_time",
        "test_issue126128",
        "test_primtorch_no_graph_break",
        "test_nn_module_callable",
        "test_torchname",
        "test_specialized_stride",
        "test_delsubscr_raises",
        "test_generator_dealloc",
        "test_lru_cache_warning_issued_during_tracing",
        "test_312_local_cell_overlap",
        "test_issue134451",
        "test_property_setter_with_dict_get_176608",
        "test_trace_functional_tensor_with",
        "test_nn_module_property_closure",
        "test_split_with_sizes_aot_autograd",
        "test_detectron2_instances_cat",
        "test_get_parameter_dtype",
        "test_Size",
        "test_nn_module_stack_bc",
        "test_issue1466_size_aot_autograd",
        "test_randint_out_dynamic",
        "test_staticmethod_allow_in_graph",
        "test_tuple_enum_as_key_dict",
        "test_get_type_hints",
        "test_abc_setattr",
        "test_stk_sdd_is_transposed",
        "test_issue164247_backend_eager",
        "test_typed_dict",
        "test_nn_param_freevar_codegen",
        "test_recursive_map",
        "test_disabling_unpack_hooks_within_compiled_region",
        "test_global_fn_mutation",
        "test_typed_dict_total",
        "test_reformer_eval",
    ),
