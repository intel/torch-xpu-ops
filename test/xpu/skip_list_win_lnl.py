skip_dict = {
    ...
    "test_unary_ufuncs_xpu.py": (
        ...
        "test_reference_numerics_large_sinh_xpu_complex32",
    ...
    "test_reductions_xpu.py": (
        "test_noncontiguous_expanded__refs_prod_xpu_complex128",
        "test_noncontiguous_expanded_masked_prod_xpu_complex128",
        "test_noncontiguous_transposed__refs_prod_xpu_complex128",
        "test_noncontiguous_transposed_masked_prod_xpu_complex128",
        "test_ref_duplicate_values__refs_prod_xpu_complex128",
        "test_ref_duplicate_values_masked_prod_xpu_complex128",
        "test_ref_duplicate_values_prod_xpu_complex128",
        "test_ref_small_input__refs_prod_xpu_complex128",
        "test_ref_small_input_masked_prod_xpu_complex128",
        "test_reference_masked_masked_prod_xpu_complex128"",
    )
