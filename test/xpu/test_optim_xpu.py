...
register_test(
    TestOptimRenewed,
    TestOptimRenewed.test_fused_cpu_matches_cuda,
    _test_fused_cpu_matches_cuda,
)
...
register_test(
    TestOptimRenewed,
    TestOptimRenewed.test_peak_memory_foreach,
    _test_peak_memory_foreach,
)
...
register_test(
    TestOptimRenewed,
    TestOptimRenewed.test_state_dict_with_cuda_params,
    _test_state_dict_with_cuda_params,
)
