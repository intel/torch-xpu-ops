...
|-------|------------|----|----|-----|--------|---------------|--------------|--------------|--------------|
| DeepSeek 4 Flash | 4bit MoE, 8bit dense | 4 | 64 | 3584 | 4096 | **896(DT=8bit)MB** | **25.27** | **1792 MB** | **54.18** |
| Qwen 3 235B | MXFP8, BF16 GQA | 4 | 16 | 3584 | 4096 | **224(DT=8bit)MB** | **6.35** | **448 MB** | **13.60** |
| Qwen 3 235B | BF16 | 4 | 4 | 3584 | 4096 | **112 MB** | **3.19** | **112 MB** | **3.43** |
| Qwen 3 235B | MXFP4 MoE | 4 | 32 | 3584 | 4096 | **448(DT=8bit)MB** | **12.65** | **896 MB** | **27.13** |
| Hunyuan 3 | MXFP8, 8bit GQA | 4 | 4 | 4096 | 4096 | **64(DT=8bit)MB** | **1.84** | **128 MB** | **3.91** |
...
| Model | Assumption | TP | BS | seq | hidden | AG Size (OUT) | AG Time (ms) | RS Size (IN) | RS Time (ms) |
|-------|------------|----|----|-----|--------|---------------|--------------|--------------|--------------|
| DeepSeek 4 Pro | 4bit MoE, 8bit dense | 8 | 16 | 3584 | 7168 | **392(DT=8bit)MB** | **16.07** | **784 MB** | **33.11** |
...
|-------|------------|----|----|--------|---------------|-----------------|--------------|-----------------|
| DeepSeek 4 Flash | 4bit MoE, 8bit dense | 4 | 64 | 4096 | **256(DT=8bit)KB** | **14.87** | **512 KB** | **25.09** |
| Qwen 3 235B | MXFP8, BF16 GQA | 4 | 16 | 4096 | **64(DT=8bit)KB** | **12.10** | **128 KB** | **12.30** |
| Qwen 3 235B | BF16 | 4 | 4 | 4096 | **32 KB** | **11.41** | **32 KB** | **12.83** |
| Qwen 3 235B | MXFP4 MoE | 4 | 32 | 4096 | **128(DT=8bit)KB** | **10.14** | **256 KB** | **15.40** |
| Hunyuan 3 | MXFP8, 8bit GQA | 4 | 4 | 4096 | **16(DT=8bit)KB** | **12.30** | **32 KB** | **12.83** |
...
| Model | Assumption | TP | BS | hidden | AG Size (OUT) | AG Latency (µs) | RS Size (IN) | RS Latency (µs) |
|-------|------------|----|----|--------|---------------|-----------------|--------------|-----------------|
| DeepSeek 4 Pro | 4bit MoE, 8bit dense | 8 | 16 | 7168 | **112(DT=8bit)KB** | **15.68** | **224 KB** | **26.09** |
