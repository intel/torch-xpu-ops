 ...
 *
 * Usage:
 *   mpirun -n 4 ./bench_ccl_allgather --min 12 --max 28    # 2^12 to 2^28 elements
 *   mpirun -n 4 ./bench_ccl_allgather --sizes 917504,1835008  # exact element counts
 *   mpirun -n 4 ./bench_ccl_allgather --sizes-kb 1792,3584    # exact KB sizes
 *   mpirun -n 4 ./bench_ccl_allgather --sizes-mb 896,1792     # exact MB sizes
 */
