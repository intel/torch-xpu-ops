...
Usage:
    ...
    mpirun -n 2 python test_allreduce.py --impl one_shot       # custom SYCL one-shot (XPU)
    mpirun -n 2 python test_allreduce.py --impl two_shot       # custom SYCL two-shot (XPU)
    mpirun -n 2 python test_allreduce.py --profile --impl symm_mem
    mpirun -n 2 python test_allreduce.py --accuracy --impl ring_pull

Note: one_shot / two_shot auto-set USE_SIGNAL_BARRIER=1 at import time
(default XCCL-allreduce barrier dominates small-message latency on BMG).
"""
...
from allreduce_impl import (
    ...
    allreduce_one_shot_custom,
    allreduce_two_shot_custom,
)
...
IMPL_MAP = {
    ...
    "one_shot": allreduce_one_shot_custom,
    "two_shot": allreduce_two_shot_custom,
}
...
def init_distributed():
    """Initialize distributed environment. Supports mpirun (PMI_*) and torchrun (RANK/WORLD_SIZE)."""
