...
class TestXpuOpsHeader(TestCase):
    def test_xpu_ops_header(self):
        ...
        self.assertTrue(os.path.exists(os.path.join(aten_ops_dir, "cat_xpu_dispatch.h")))
        self.assertTrue(os.path.exists(os.path.join(aten_ops_dir, "index_fill_xpu_dispatch.h")))
