...
class TestTorchMethod(TestCase):
    def test_fp8_downcast_copy_float8_e4m3(self, dtype=torch.float8_e4m3fn):
        ...
        tensor_fp32 = torch.rand((32, 32), dtype=torch.float32, device=torch.device("xpu")) / 10
    ...
    def test_fp8_downcast_copy_float8_e5m2(self, dtype=torch.float8_e5m2):
        seed = 123
        torch.manual_seed(seed)
        tensor_fp16 = torch.rand((64, 32), dtype=torch.float16, device=torch.device("xpu")) / 10
