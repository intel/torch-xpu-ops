...
def simple_test(in_shape, scale_factor, backward, dtype):
    ...
    output = torch.nn.functional.interpolate(in_tensor, mode="bilinear", scale_factor=scale_factor, align_corners=True)
...
shape_list = [[1, 3, 1200, 1200], [1, 128, 1200, 1200], [1, 3, 1200, 1200], [128, 128, 5, 5]]
