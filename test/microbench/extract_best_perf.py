...
def main():
    ...
    parser.add_argument("-i", "--input", required=True, help="Input CSV file (semicolon-separated)")
    parser.add_argument("-o", "--output", required=True, help="Output CSV file (semicolon-separated)")
