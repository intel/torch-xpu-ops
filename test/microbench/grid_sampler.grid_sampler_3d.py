...
def Grad_sample3d(shape, dtype, backward, mode, padding_mode, align_corners, device):
    N, C, D, H, W = shape
...
def run_profile(shape, dtype, backward, mode, padding_mode, align_corners, device, num_iter):
    with profile(
        ...
        for _ in range(num_iter):
            Grad_sample3d(shape, dtype, backward, mode, padding_mode, align_corners, device)
            ...
            for mode in ["bilinear", "nearest"]:
                for padding_mode in ["zeros", "border", "reflection"]:
                    for align_corners in [True, False]:
                        # warm up
                        Grad_sample3d(shape, dtype, backward, mode, padding_mode, align_corners, args.device)
