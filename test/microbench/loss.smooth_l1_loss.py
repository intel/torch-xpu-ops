        ...
        for dtype in [torch.bfloat16, torch.float16, torch.float32]:
            for reduce in ["none", "mean"]:
                ...
                if not args.e2e_only:
                    run_profile(loss, input, target, dtype, cache_r, cache_w, args.device, args.num_iter)

                if not args.profile_only:
                    run_e2e(loss, input, target, dtype, cache_r, cache_w, args.device, args.num_iter)
