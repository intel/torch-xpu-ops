...
class TestProfilerCorrectness(TestCase):
    """Profiler correctness tests for XPU.

    Converted from assertion-free reproducer scripts under test/profiling/
    into proper TestCase methods with assertions that validate profiler output.
    """
    ...
    # ------------------------------------------------------------------
    # Profiles a sequence of distinct ops and verifies that the trace
    # contains kernel events with correlation IDs linking back to CPU ops.
    # ------------------------------------------------------------------
