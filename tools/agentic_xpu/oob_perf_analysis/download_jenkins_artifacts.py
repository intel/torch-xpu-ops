...
Usage (CLI arguments — legacy):
    python scripts/download_jenkins_artifacts.py \
        ...
        [--server https://jenkins-aten-caffe2.sh.intel.com] \
        [--user lifengwa --token <token>] \
        [--parallel 5] \
        [--dry-run]
...
DEFAULT_SERVER = "https://jenkins-aten-caffe2.sh.intel.com"
...
def load_session_config(yaml_path):
    ...
    Example:
        t1: https://jenkins-aten-caffe2.sh.intel.com/job/newOOB_launch_benchmark_trigger/743/
        unitrace: https://jenkins-aten-caffe2.sh.intel.com/job/newOOB_launch_benchmark_trigger/738/
