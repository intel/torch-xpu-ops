...
fail; they did not run. A failing case in such a module is classified `unknown`
rather than `new_case_failure`, because "absent from the baseline" stops
meaning "new test" once the module's names have moved.
