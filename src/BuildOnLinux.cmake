...
macro(setup_common_libraries)
  ...
  if(USE_C10D_XCCL)
    ...
    if(USE_ISHMEM AND PYTORCH_FOUND_ISHMEM)
      target_compile_definitions(torch_xpu_ops PRIVATE USE_ISHMEM)
...
if(BUILD_SEPARATE_OPS)
  ...
  if(USE_C10D_XCCL)
    ...
    if(USE_ISHMEM AND PYTORCH_FOUND_ISHMEM)
      target_compile_definitions(torch_xpu_ops PRIVATE USE_ISHMEM)
      # Link ISHMEM include directories
      target_include_directories(torch_xpu_ops PRIVATE ${ISHMEM_INCLUDE_DIR})
      # Apply WHOLE_ARCHIVE directly to the static library file
      target_link_libraries(torch_xpu_ops PUBLIC -Wl,--whole-archive ${ISHMEM_LIBRARY} -Wl,--no-whole-archive)
    endif()
  endif()
