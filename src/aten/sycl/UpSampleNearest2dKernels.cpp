...
template <typename scalar_t, typename index_op_t>
void upsample_nearest2d_out_frame(
    const scalar_t* idata,
    scalar_t* odata,
    const size_t nc,
...
template <typename scalar_t, typename accscalar_t, typename index_bw_op_t>
void upsample_nearest2d_backward_out_frame(
    size_t n,
    const scalar_t* grad_o,
    size_t dim_b,
    size_t dim_c,
  ...
  UpsampleNearest2dBackwardKernelFunctor<scalar_t, accscalar_t, index_bw_op_t>
      kfn(n,
          grad_o,
          dim_b,
          dim_c,
...
template <typename scalar_t, typename accscalar_t, typename index_bw_op_t>
void upsample_nearest2d_backward_nhwc_out_frame(
    const scalar_t* go,
    scalar_t* gi,
    const size_t height1,
    const size_t width1,
