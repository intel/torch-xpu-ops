...
struct Boffset {
  ...
  index_t do_offset(const index_t b_id, const index_t h_id, const index_t s_id) {
  ...
  index_t dqaccum_offset(
      ...
      const index_t h_id,
      const index_t s_id) {
    return b_id * param.num_head_q * param.seq_len_q * param.head_dim +
        h_id * param.seq_len_q * param.head_dim + s_id * param.head_dim;
  }
