...
TORCH_XPU_API void chebyshev_polynomial_t_kernel(TensorIteratorBase& iterator);
...
TORCH_XPU_API void chebyshev_polynomial_w_kernel(TensorIteratorBase& iterator);
