...
void conv_depthwise2d_forward_generic_kernel(
...
void conv_depthwise2d_forward_kernel(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      [&] {
        ...
        if (kW == 5 && kH == 5) {
          constexpr auto kptr =
              conv_depthwise2d_forward_kernel<5, scalar_t, int>;
          int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
          ...
          constexpr auto kptr =
              conv_depthwise2d_forward_kernel<3, scalar_t, int>;
          int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
          auto global_range = xpuKernelLoopGroupRange(n, local_range);
          sycl_kernel_submit<kptr>(
              global_range * local_range,
          ...
          constexpr auto kptr =
              conv_depthwise2d_forward_kernel<1, scalar_t, int>;
          int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
          auto global_range = xpuKernelLoopGroupRange(n, local_range);
          sycl_kernel_submit<kptr>(
              global_range * local_range,
          ...
          constexpr auto kptr =
              conv_depthwise2d_forward_generic_kernel<scalar_t, int>;
          int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
          auto global_range = xpuKernelLoopGroupRange(n, local_range);
          sycl_kernel_submit<kptr>(
              global_range * local_range,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      [&] {
        ...
        if (kW == 5 && kH == 5) {
          if (dW == 1 && dH == 1) {
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<5, 1, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
            ...
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<5, 2, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
            ...
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<5, 0, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
          ...
          if (dW == 1 && dH == 1) {
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<3, 1, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
            ...
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<3, 2, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
            ...
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<3, 0, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
          ...
          if (dW == 1 && dH == 1) {
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<1, 1, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
            ...
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<1, 2, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
            ...
            constexpr auto kptr =
                conv_depthwise2d_backward_kernel<1, 0, scalar_t, int>;
            int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
            auto global_range = xpuKernelLoopGroupRange(n, local_range);
            sycl_kernel_submit<kptr>(
                global_range * local_range,
          ...
          constexpr auto kptr =
              conv_depthwise2d_backward_kernel<0, 1, scalar_t, int>;
          int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
          auto global_range = xpuKernelLoopGroupRange(n, local_range);
          sycl_kernel_submit<kptr>(
              global_range * local_range,
          ...
          constexpr auto kptr =
              conv_depthwise2d_backward_kernel<0, 2, scalar_t, int>;
          int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
          auto global_range = xpuKernelLoopGroupRange(n, local_range);
          sycl_kernel_submit<kptr>(
              global_range * local_range,
          ...
          constexpr auto kptr =
              conv_depthwise2d_backward_kernel<0, 0, scalar_t, int>;
          int64_t local_range = at::xpu::getKernelMaxWorkGroupSize<kptr>();
          auto global_range = xpuKernelLoopGroupRange(n, local_range);
          sycl_kernel_submit<kptr>(
              global_range * local_range,
...
void conv_depthwise2d_grad_weight_kernel(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      [&] {
        ...
        constexpr auto kptr =
            conv_depthwise2d_grad_weight_kernel<scalar_t, acc_t, int, 32>;
        int max_wg_size = at::xpu::getKernelMaxWorkGroupSize<kptr>();
        ...
        int64_t slm_sz = sizeof(acc_t) * local_range;
