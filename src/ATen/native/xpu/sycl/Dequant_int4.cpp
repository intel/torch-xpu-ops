  ...
  AT_DISPATCH_REDUCED_FLOATING_TYPES(
      weight.scalar_type(), "dequant_int4_kernel", [&]() {
        ...
        switch (qGroupSize) {
          case 16: {
            constexpr auto kptr =
                dequant_int4_kernel_fn<scalar_sycl_t, 16, TileK, TileN, SgSize>;
          ...
          case 32: {
            constexpr auto kptr =
                dequant_int4_kernel_fn<scalar_sycl_t, 32, TileK, TileN, SgSize>;
            sycl_kernel_submit<kptr>(
                global_range,
                local_range,
                sycl_queue,
          ...
          case 64: {
            constexpr auto kptr =
                dequant_int4_kernel_fn<scalar_sycl_t, 64, TileK, TileN, SgSize>;
            sycl_kernel_submit<kptr>(
                global_range,
                local_range,
                sycl_queue,
          ...
          case 128: {
            constexpr auto kptr = dequant_int4_kernel_fn<
                scalar_sycl_t,
                128,
                TileK,
                TileN,
