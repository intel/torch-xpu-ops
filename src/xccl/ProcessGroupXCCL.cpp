...
c10::intrusive_ptr<Work> ProcessGroupXCCL::send(
  ...
  auto ret = pointToPoint(
      ...
      [&](at::Tensor& input,
          ...
          int dst) {
        xccl::onecclSend(input, comm, dst, xcclStream, &stream.queue());
        return;
      },
      dstRank,
      OpType::SEND,
...
c10::intrusive_ptr<Work> ProcessGroupXCCL::recv(
  ...
  auto ret = pointToPoint(
      ...
      [&](at::Tensor& output,
          ...
          ccl::stream& xcclStream,
          int src) {
        xccl::onecclRecv(output, comm, src, xcclStream, &stream.queue());
        return;
      },
      srcRank,
      OpType::RECV,
...
c10::intrusive_ptr<Work> ProcessGroupXCCL::gather(
  ...
  return collective(
      ...
      [&](at::Tensor& /* unused */,
        ...
        xccl::onecclGather(
            inputTensor, outputs, comm, root, xcclStream, &stream.queue());
        return;
      },
      OpType::GATHER,
      opts.asyncOp,
...
c10::intrusive_ptr<Work> ProcessGroupXCCL::scatter(
  ...
  return collective(
      ...
      [&](at::Tensor& /* unused */,
        ...
        xccl::onecclScatter(
            inputs, outputTensor, comm, root, xcclStream, &stream.queue());
      },
      OpType::SCATTER,
      opts.asyncOp,
      "xccl:scatter",
  ...
  return collective(
      ...
      [&](at::Tensor& input,
        ...
        xccl::onecclAllReduce(
            input, output, comm, opts.reduceOp, xcclStream, &stream.queue());
  ...
  return collective(
      ...
      [&](at::Tensor& input,
        ...
        xccl::onecclBroadcast(
            input, output, comm, root, xcclStream, &stream.queue());
        return;
      },
      OpType::BROADCAST,
      opts.asyncOp,
    ...
    return collective(
        ...
        [&](at::Tensor& input,
          ...
          xccl::onecclAllGather(
              input, output, comm, xcclStream, &stream.queue());
          return;
        },
        [](at::xpu::XPUStream&,
           c10::intrusive_ptr<ProcessGroupXCCL::WorkXCCL>& work) {},
...
c10::intrusive_ptr<Work> ProcessGroupXCCL::_allgather_base(
  ...
  return collective(
      ...
      [&](at::Tensor& input,
          ...
          at::xpu::XPUStream& stream,
          ccl::stream& xcclStream) {
        xccl::onecclAllGather(input, output, comm, xcclStream, &stream.queue());
        return;
      },
  ...
  return collective(
      ...
      [&](at::Tensor& /* unused */,
        ...
        for (const int r :
          ...
          if (input.numel() != 0) {
            xccl::onecclSend(input, comm, r, xcclStream, &stream.queue());
          }
          if (output.numel() != 0) {
            xccl::onecclRecv(output, comm, r, xcclStream, &stream.queue());
          }
        }
        xccl::oneccl_group_end();
        return;
