...
# Install: crontab -e → */10 * * * * ~/torch-xpu-ops/.github/issue-handler/scripts/cron.sh
...
cd "$AGENT_DIR"
/mnt/miniforge3/envs/yucai3/bin/python scripts/run_pipeline.py --once >> "$LOG_DIR/cycle-$TIMESTAMP.log" 2>&1
EXIT_CODE=$?
