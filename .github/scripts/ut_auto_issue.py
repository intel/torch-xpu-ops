...
def unknown_evidence(sub: SubGroup) -> str:
    ...
    return (
        f"**Baseline unavailable** for {cats} - no nightly within the lookback "
        "completed the category healthily, so regression status could not be "
        "determined. Stating the reason matters; a silently missing block is "
