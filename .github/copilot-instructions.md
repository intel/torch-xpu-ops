...
src/ATen/native/quantized/     # Quantized op dispatch + SYCL kernels
src/ATen/native/sparse/xpu/    # Sparse tensor XPU implementations
src/ATen/native/transformers/  # Attention/SDP dispatch + SYCL kernels
...
yaml/xpu_functions.yaml         # XPU-specific function declarations
test/xpu/                       # XPU device tests (pytest-based)
test/regressions/               # Regression tests
test/sycl/                      # SYCL C++ unit tests (CMake)
test/microbench/                # Microbenchmarks
test/profiling/                 # Profiling tests
test/repro/                     # Reproduction scripts
